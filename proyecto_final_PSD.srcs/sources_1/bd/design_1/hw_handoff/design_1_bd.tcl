...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXIS_CONFIG_0_1 [get_bd_intf_ports S_AXIS_CONFIG_0] [get_bd_intf_pins fft/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net S_AXIS_DATA_0_1 [get_bd_intf_ports S_AXIS_DATA_0] [get_bd_intf_pins fft/S_AXIS_DATA]
  connect_bd_intf_net -intf_net fft_M_AXIS_DATA [get_bd_intf_ports M_AXIS_DATA_0] [get_bd_intf_pins fft/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net s_axis_aclk_0_1 [get_bd_ports s_axis_aclk_0] [get_bd_pins fft/aclk]
